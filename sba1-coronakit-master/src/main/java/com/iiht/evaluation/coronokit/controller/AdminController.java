	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "editproduct":
				...
				ProductMaster pm = lp.searchProduct(editId);
				System.out.println(pm.getProductDescription());
				request.setAttribute("editProduct", pm);
				break;
			case "updateproduct":
			...
			case "list":
				...
				List<ProductMaster> list = lp.addNewProduct(id, name, cost, desc);
